...
//		console.log("ddddd----width---"+this._container. + "---"+document.documentElement.clientWidth)
        this._viewPortWidth = window.innerWidth*0.7 || document.documentElement.clientWidth*0.7;
